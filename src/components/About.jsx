  ...
  return (
    <>
      ...
      <AboutCollection>
        ...
        >
          Fleets keep track of the daily expenses and reports made by the
          drivers, such as fuel expenses, fines, vehicle conditions and much
          more.{" "}
        </h3>
        <Card3>
          <AboutImage src="" alt="" />
        ...
        <Card4>
          <AboutText>
            ...
            contains fields about expenses, incidents as well vehicle conditions
          </AboutText>
          <AboutImage src="" alt="" />
        </Card4>
        <Card3>
